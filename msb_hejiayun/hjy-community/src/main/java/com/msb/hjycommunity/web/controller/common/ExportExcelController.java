...
public class ExportExcelController extends BaseController {
    ...
    public BaseResponse exportExcel(HjyCommunity hjyCommunity,
        ...
        ExcelUtils.exportExcel(excelDtoList, HjyCommunityExcelDto.class,
                "小区信息.xls", response, new ExportParams("小区信息列表", "小区信息"));
        return BaseResponse.success("导出小区信息到Excel成功");
        // http://localhost:8888/hejiayun/exportExcel/exportCommunityExcel?pageNum=1&amp;pageSize=10
    }
}
